...
import com.fatihcetiner.countrieskt.service.CountryAPIService
import com.fatihcetiner.countrieskt.service.CountryDatabase
import com.fatihcetiner.countrieskt.util.CustomSharedPreferences
...
class FeedViewModel(application: Application) : BaseViewModel(application) {
    ...
    private fun getDataFromSQLite() {
        launch {
            val countries = CountryDatabase(getApplication()).countryDao().gelAllCountries()
